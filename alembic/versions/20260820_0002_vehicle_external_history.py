...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("normalized_brand", sa.String(255)),
        sa.Column("model", sa.String(255)),
        sa.Column("normalized_model", sa.String(255)),
        sa.Column("year", sa.Integer()),
        sa.Column("price", sa.Numeric(14, 2)),
        sa.Column("currency", sa.String(3)),
        sa.Column("mileage", sa.Integer()),
        sa.Column("mileage_unit", sa.String(10)),
        sa.Column("normalized_mileage_km", sa.Integer()),
    ...
    op.create_index(
        "ix_marketplace_vin_seen", "marketplace_listings", ["normalized_vin", "last_seen_at"]
    )
    op.create_index(
        "ix_marketplace_vehicle_seen", "marketplace_listings", ["vehicle_id", "last_seen_at"]
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column("normalized_vin", sa.String(17), nullable=False),
        sa.Column("provider", sa.String(50), nullable=False),
        sa.Column("auction_name", sa.String(100)),
        sa.Column("lot_number", sa.String(100)),
        sa.Column("auction_date", sa.DateTime(timezone=True)),
        sa.Column("location", sa.String(255)),
        sa.Column("seller_type", sa.String(100)),
        sa.Column("sale_status", sa.String(100)),
        sa.Column("final_bid", sa.Numeric(14, 2)),
        sa.Column("currency", sa.String(3)),
        sa.Column("estimated_retail_value", sa.Numeric(14, 2)),
        sa.Column("repair_cost", sa.Numeric(14, 2)),
        sa.Column("primary_damage", sa.String(255)),
        sa.Column("secondary_damage", sa.String(255)),
        sa.Column("odometer", sa.Integer()),
        sa.Column("odometer_unit", sa.String(10)),
        sa.Column("normalized_odometer_km", sa.Integer()),
        sa.Column("odometer_status", sa.String(100)),
        sa.Column("title_type", sa.String(255)),
        sa.Column("keys_available", sa.Boolean()),
        sa.Column("run_and_drive", sa.Boolean()),
        sa.Column("engine_starts", sa.Boolean()),
    ...
    op.create_table(
        ...
        sa.Column(
            "auction_event_id",
            sa.Integer(),
            sa.ForeignKey("auction_events.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("normalized_vin", sa.String(17), nullable=False),
        sa.Column("observed_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("original_mileage", sa.Integer(), nullable=False),
        sa.Column("original_unit", sa.String(10), nullable=False),
        sa.Column("normalized_mileage_km", sa.Integer(), nullable=False),
